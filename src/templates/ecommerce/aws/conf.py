...
try:
    ...
    AWS_ACCESS_KEY_ID = os.environ.get("AWS_ACCESS_KEY_ID", "AKIAJ53QOTYNDKU42VHA")
    AWS_SECRET_ACCESS_KEY = os.environ.get("AWS_SECRET_ACCESS_KEY", "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")

AWS_GROUP_NAME = "demogroup"
AWS_USERNAME = "shivank01"
